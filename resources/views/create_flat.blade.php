...
<html>
	<head>
		...
		<title>Maintenant | New Flat</title>
	...
	<body class="loading-overlay-showing" data-loading-overlay data-plugin-options="{'hideDelay': 500}">
		...
		<div class="body">
			...
			<div role="main" class="main">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
								<h1 class="text-dark">Create New Flat</h1>
							</div>
						</div>
					</div>
				</section>
				...
				<div class="container">
                    <form role="form" class="needs-validation" method="post" action="/storeflatdetails" enctype="multipart/form-data">
                        @csrf
                        <h2 class="text-color-dark font-weight-bold text-5-5 mb-3">Flat Details</h2>
								<div class="form-row">
                                    <div class="form-group col-md-4">
										<label>Flat Name<span class="text-color-danger">*</span></label>
										<input type="text" class="form-control h-auto py-2" name="flat_name" required />
									</div>
									<div class="form-group col-md-4">
										<label>Owner<span class="text-color-danger">*</span></label><br>
										<select style="width:100px"  name="owner_id" required>
									...
									<div class="form-group col-md-4">
										...
										<input type="number" class="form-control h-auto py-2" name="beds" required />
									</div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
										...
										<input type="number" class="form-control h-auto py-2" name="baths" required />
									</div>
                                    <div class="form-group col-md-4">
										<label>Size in squre feet<span class="text-color-danger">*</span></label>
										<input type="number" class="form-control h-auto py-2" name="size" required />
									</div>
									<div class="form-group col-md-4">
										<label>Flat Rent <span class="text-color-danger">*</span></label>
										<input type="number" class="form-control h-auto py-2" name="rent" required />
									</div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
										...
										<input type="number" class="form-control h-auto py-2" name="service_charge" required />
									</div>
									<div class="form-group col-md-4">
										<label>Image<span class="text-color-danger">*</span></label>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
										...
										<input type="number" class="form-control h-auto py-2" name="monthly_water_bill" required />
									</div>
                                    <div class="form-group col-md-4">
                                        <label>Gas Bill <span class="text-color-danger">*</span></label>
										<input type="number" class="form-control h-auto py-2" name="monthly_gas_bill" required />
									</div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
										...
										<input type="number" class="form-control h-auto py-2" name="garage_bill" required />
									</div>
                                    <div class="form-group col-md-4">
                                        <label>Location<span class="text-color-danger">*</span></label>
										<input type="text" class="form-control h-auto py-2" name="location" required />
									</div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                ...
                                <br>
                                <button type="submit" class="btn btn-dark btn-modern btn-block text-uppercase bg-color-hover-primary border-color-hover-primary border-radius-0 text-3 py-3">Add Flat <i class="fas fa-arrow-right ml-2"></i></button>
							</div>
						</div>
                    </form>
                </div>
