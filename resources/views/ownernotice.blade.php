		...
		<div class="body">
			...
			<div role="main" class="main">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
								<h1 class="text-dark">Create A New Notice</h1>
							</div>
						</div>
					</div>
				</section>
				...
				<div class="container">
                            ...
                            <form class="contact-form" action="/owner-notice" method="post">
                            @csrf
								<div class="form-row">
									<div class="form-group col-lg-6">
										<label>Notice Title</label>
										<input type="text" data-msg-required="Please enter the notice title." class="form-control" name="title" required>
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col">
										<label>Notice</label>
										<textarea data-msg-required="Please enter the notice." rows="5" class="form-control" name="notice" required></textarea>
									</div>
								</div>
								<button type="submit" class="btn btn-dark btn-modern btn-block text-uppercase bg-color-hover-primary border-color-hover-primary border-radius-0 text-3 py-3">Add Notice <i class="fas fa-arrow-right ml-2"></i></button>
							</form>
